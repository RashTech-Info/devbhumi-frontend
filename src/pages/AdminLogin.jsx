...
function Adminlogin() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      const response = await axios.post(`${import.meta.env.VITE_API_BASE}/adminLogin`, {
        email: email,
        pass: password
      });
      ...
      if (response.data.success) {
        ...
        Cookies.set('devjwt', response.data.token, { expires: 1 }); // Expires in 1 day
  ...
  const handleForgotPassword = async (e) => {
    ...
    setIsSubmitting(true);
    try {
      const response = await axios.post(`${import.meta.env.VITE_API_BASE}/adminSend_otp`, {
        email: forgotEmail
      });
  ...
  const handleOtpVerification = async (e) => {
    ...
    setIsSubmitting(true);
    try {
      const response = await axios.post(`${import.meta.env.VITE_API_BASE}/adminVerify`, {
        email: forgotEmail,
        otp: otp
      });
  ...
  const handlePasswordReset = async (e) => {
    ...
    setIsSubmitting(true);
    try {
      const response = await axios.post(`${import.meta.env.VITE_API_BASE}/adminChangePass`, {
        email: forgotEmail,
        newpass: newPassword
      });
